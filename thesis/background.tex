...
Dealing with those types of failure (especially malicious nodes) require a different set of algorithms, with significantly less performance.
...
Unlike the original Paxos\cite{paxos}, Raft provides a complete solution to build a replicated state machine.
